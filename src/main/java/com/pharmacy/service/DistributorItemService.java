...
public class DistributorItemService{
	...
	/*public int getQuantityItemIdAndName(int id,String itemName) {
		System.out.println("return values "+distributorItemRepo.findByIdAndItemName(id,itemName).getQuantity());
		return distributorItemRepo.findByIdAndItemName(id,itemName).getQuantity();
	}*/
