              ...
              <%}if(role.equals("DISTRIBUTOR") || role.equals("ADMIN")) {%>
                ...
                <div class="card shadow bg-body border-primary rounded " style="width: 25rem;">
                  ...
                  <div class="card-body text-center">
                    ...
                    <a href="items.jsp" class="btn btn-custom rounded-pill w-75"><span class="text-white">Click here</span></a>
                  </div>
                </div>
              </div>
              <%}if(role.equals("USER") || role.equals("DISTRIBUTOR")){ %>
                ...
                <div class="card shadow bg-body border-primary rounded " style="width: 25rem;">
                  ...
                  <div class="card-body text-center">
                    ...
                    <hr>
                    <p class="text-center lead"><%if(role.equals("USER")){%>View your recently placed orders along with their bills<%}else{%>
              ...
              <%}if(role.equals("ADMIN")){ %>
                ...
                <div class="card shadow bg-body border-primary rounded " style="width: 25rem;">
                  ...
                  <div class="card-body text-center">
                    ...
                    <a href="<%=request.getContextPath() %>/GetAllUsers" class="btn btn-custom rounded-pill w-75"><span class="text-white">Click here</span></a>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
