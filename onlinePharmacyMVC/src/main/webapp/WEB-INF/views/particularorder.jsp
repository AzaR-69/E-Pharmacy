...
<%@page import="com.pharmacy.model.ParticularOrderProductBean"%>
...
window.onload = function () {
	...
	if (session.getAttribute("username") == null || role == null) {
		...
		List<ParticularOrderProductBean> products = (List<ParticularOrderProductBean>)request.getAttribute("products");
						...
						<div class="col-12 col-lg-10 offset-lg-1">
							...
							<div class="mt-4">
								...
								<%
									...
									if (order.isMedicine()) {
								%>
								<img class="text-center border border-secondary mt-2" src="<%=request.getContextPath()%>/showPrescription?id=${order.orderId}"
									id="prescription" />
								<%}
									if (products != null) {
