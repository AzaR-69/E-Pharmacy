...
<body>
	...
	if(role==null){response.sendRedirect("login");}
	else{
	%>
        ...
        <div class="row">
          <div class=" col-lg-12 col-sm-12">
            ...
            <%if(role.contains("USER")){ %>
              ...
              <%}if(role.contains("DISTRIBUTOR") || role.contains("ADMIN")) {
                   %>
              	<div class="col-md-4">
                <div class="card shadow bg-body border-primary rounded " style="width: 25rem;">
              ...
              <%}if(role.contains("USER") || role.contains("DISTRIBUTOR")){ 
                    %>
              	<div class="col-md-4">
                <div class="card shadow bg-body border-primary rounded " style="width: 25rem;">
                  <img
                  ...
                  <div class="card-body text-center">
                    ...
                    <hr>
                    <p class="text-center lead"><%if(role.contains("USER")){%>View your recently placed orders along with their bills<%}else{%>
