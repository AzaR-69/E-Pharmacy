							...
							<%
								...
								<div class="form-check form-check-inline ms-3">
									<input type="radio" class="form-check-input"
										name="checkbox" id="update" value="update" checked/>
									<label class="form-check-label" for="update"> Update
										List </label>
								</div>
								<div class="form-check form-check-inline">
									<input type="radio" class="form-check-input" 
										name="checkbox" value="checkout" id="checkout" />
									<label class="form-check-label" for="checkout">
										Checkout </label>
								</div>
								<div class="form-check form-check-inline">
									<input type="radio" class="form-check-input" 
										name="checkbox" value="clear" id="clear" />
